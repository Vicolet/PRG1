/*
   Programme de test d'une classe Uint permettant de travailler sur des
   entiers naturels de taille non limitée
   Suppose l'existence d'une fonction de prototype bool prime(Uint)
   testant rapidement la primalité de son paramètre
   E. Taillard, 12.12.2022
*/
...
int main() {
   ...
   cout << set_base(16) << "Modificateur d'impression Uint\n";
